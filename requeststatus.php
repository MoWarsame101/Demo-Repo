<?php
include_once  "../admindash/includes/security.php";
include_once  "../admindash/includes/process.php";
include_once "../admindash/includes/db.php";
...
<div class="card-body">
  ...
  $sql = "SELECT `id`,`username`,`Description`, `departments`, `PO`, `Type`, `price`, `quantity`, `status`, `purchaseCost`, `requested`, `remaining`,`approvedBy` FROM `requestasset` ";
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="hidden" name="request_approve" value="<?php echo $row['id']; ?>">
                                       <button class="btn btn-primary btn-sm " type="submit" name="approve-request">Approve Request</button>
                                    </form>
                                </td>
