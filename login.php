...
<body class="bg-dark">
    ...
    <div class="container mt-5 rounded-0 shadow">
                ...
                <div class="card o-hidden border-0  my-5 ">
                    <div class="card-body p-0">
                        ...
                        <div class="row shadow">
                            <div class="col-lg-6 d-none d-lg-block"><img src="img/demologo.png" width="60%" height="30%" style="margin-left:90px;margin-top:150px;"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
