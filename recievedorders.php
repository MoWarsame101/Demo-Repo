...
<div class="card-body">
  ...
  $sql = "SELECT * FROM orderasset WHERE username = '$user' and status='Recieved'";
...
<div class="form-row">
  <div class="form-group col-md-12">
    ...
    <input type="text"  class="form-control" id="col0" name="description" readonly>
  </div>
